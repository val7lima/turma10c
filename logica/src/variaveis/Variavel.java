...
public class Variavel {
	...
	public static void main(String[] args) {
		...
		/*
		 * Tipos de Dados=>
		 * Alfanumérico: é o dados que nao dever utilizado em operação matematica
		 * CEP=> 00010-009 (dentro do contexto para CEP)
		 * 
		 * Numérico: é o dado ser usado em operação matematica
		 * ele é um dado chave de busca dentro da aplicacao
