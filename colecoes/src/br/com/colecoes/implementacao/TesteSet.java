...
public class TesteSet {
	...
	public static void main(String[] args) {
		...
		//hash é obrigado FOREACH, nao tem contador
...
//		 }
		...
		//hash guarda no melhor lugar, input mais demorado, mas output é rapido
		//lista guarda no lugar mais rapido, input é mais rapido, e output é mais demorado
