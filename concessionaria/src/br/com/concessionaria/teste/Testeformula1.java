...
public class Testeformula1 {
	...
	public static void main(String[] args) {
		...
		//criar um objeto, nao tem as informaçoes da classe
		Formula1 objeto = null; // criando objeto, nao consegue buscar as caracteristicas, nao tem espaço na memoria
		String nome = ""; // é uma Classe, objeto referencia, 
		int numero=0; // tipo primitivo
		//Instancia um objeto, tem as informaçoes da classe
